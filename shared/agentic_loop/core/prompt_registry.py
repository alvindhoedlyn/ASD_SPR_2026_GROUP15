"""
SHARED prompt registry. Resolves prompt files under <app_dir>/prompts/<family>/...
Raises a clear error naming the missing file rather than a bare FileNotFoundError.
"""
